...
def _sheet_dashboard(wb):
    ...
    phases = [
        ...
        ["Phase 2 – Fix Critical Issues","Days 8–37",  "Security fixed, bugs corrected, Grafana live",      "In Progress", "~40%"],
        ["Phase 3 – New Strategies",    "Days 38–82", "8 new strategies built and backtested",             "Not Started", "0%"],
...
def _phase2_tasks():
    return [
        ...
        ("Add fill confirmation polling loop",        "execution/order_execution_engine.py",       "Day 13",   "1 day",  "HIGH",     "In Progress", "5x retry loop exists but logs POST_EXECUTION_POSITION_NOT_CONFIRMED every cycle — needs real fill poll"),
        "MEDIUM SEVERITY",
        ...
        ("Add crash recovery on startup",             "core/engine.py",                            "Day 21",   "1 day",  "MED",      "In Progress", "Exchange reconciliation on startup partially covers this (Fixes 1–4 applied this session)"),
        ...
        ("Portfolio confidence scores too low",       "strategy/portfolio.py",                     "Next",     "1 day",  "HIGH",     "Not Started", "Scores 0.24-0.45 vs min_signal_confidence=0.6; bot executes anyway but risk checks often block. Needs threshold tuning or scoring rebalance"),
        "MONITORING",
...
def _sheet_known_issues(wb):
    ...
    issues = [
        ...
        ["HIGH", "Portfolio confidence scores 0.24–0.45",  "strategy/portfolio.py",                 "Next session",  "Not Fixed",  "Below min_signal_confidence=0.6 threshold","Scoring or threshold needs rebalancing"],
        ...
        ["MED",  "No fill confirmation polling",           "execution/order_execution_engine.py",   "Phase 2",       "In Progress","Order could be rejected silently",      "5x retry loop exists but POST_EXECUTION_POSITION_NOT_CONFIRMED still fires"],
